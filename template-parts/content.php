					...
					<div class="thunk-posts-description ">
						...
						<div class="thunk-post-comments">
							<div class="thunk-comments-icon">
								<span class="thunk-comments"><a href="<?php comments_link(); ?>" title=""><?php comments_popup_link(esc_html('0','open-mart'), esc_html('1','open-mart'), esc_html('%','open-mart')); ?></a></span>
							</div>
						</div>
					    </div>
						<div class="thunk-post-excerpt">
								<?php open_mart_the_excerpt();?> 
						</div>
