...
OPNCustomizerToggles ['open_mart_above_footer_layout'] = [
		    {
				controls: [    
				'open_mart_above_footer_col1_set',
				'open_mart_above_footer_col2_set',
				'open_mart_above_footer_col3_set',
				'open_mart_footer_col1_texthtml',
				'open_mart_footer_col1_widget_redirect',
	            'open_mart_footer_col1_menu_redirect',
				'open_mart_footer_col1_social_media_redirect',
				'open_mart_above_footer_col2_texthtml',
				'open_mart_above_footer_col2_widget_redirect',
				'open_mart_above_footer_col2_menu_redirect',
				'open_mart_above_footer_col2_social_media_redirect',
				'open_mart_above_footer_col3_texthtml',
				'open_mart_above_footer_col3_widget_redirect',
				'open_mart_above_footer_col3_menu_redirect',
				'open_mart_above_footer_col3_social_media_redirect',
				'open_mart_above_ftr_hgt',
				'open_mart_abv_ftr_botm_brd',
				'open_mart_above_frt_brdr_clr',
				],
			...
			},
           {
...

			{
				...
				callback: function(layout){
					var val = api( 'open_mart_above_footer_col1_set' ).get();
			...
			// col2
			{
				...
				callback: function(layout){
					var val = api( 'open_mart_above_footer_col2_set' ).get();
			...
			// col3
			{
				...
				callback: function(layout){
					var val = api( 'open_mart_above_footer_col3_set' ).get();
...
OPNCustomizerToggles ['open_mart_above_footer_col1_set'] = [
		    {
				controls: [    
				'open_mart_footer_col1_texthtml',
				'open_mart_footer_col1_widget_redirect',
				...
				callback: function(layout){
					var val = api( 'open_mart_above_footer_layout' ).get();
...
OPNCustomizerToggles ['open_mart_above_footer_col2_set'] = [
		    {
				controls: [    
				'open_mart_above_footer_col2_texthtml',
				'open_mart_above_footer_col2_widget_redirect',
...
OPNCustomizerToggles ['open_mart_above_footer_col3_set'] = [
		    {
				controls: [    
				'open_mart_above_footer_col3_texthtml',
				'open_mart_above_footer_col3_widget_redirect',
