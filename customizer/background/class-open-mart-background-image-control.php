...
/**
 * Customize API: open_mart_Customize_Custom_Background_Control class
 *
...
class open_mart_Customize_Custom_Background_Control extends WP_Customize_Upload_Control{
	...
	public static function get_button_labels() {
		...
		$button_labels = array(
			'select'       => __( 'Select Image', 'open-mart' ),
			'change'       => __( 'Change Image', 'open-mart' ),
			'remove'       => __( 'Remove', 'open-mart' ),
			'default'      => __( 'Default', 'open-mart' ),
			'placeholder'  => __( 'No image selected', 'open-mart' ),
			'frame_title'  => __( 'Select Image', 'open-mart' ),
			'frame_button' => __( 'Choose Image', 'open-mart' ),
		);
	...
	public static function get_field_labels() {
		...
		$field_labels = array(
			'repeat'	=> __( 'Background Repeat', 'open-mart' ),
			'size'		=> __( 'Background Size', 'open-mart' ),
			'position'	=> __( 'Background Position', 'open-mart' ),
			'attach'	=> __( 'Background Attachment', 'open-mart' )
		);
	...
	public static function get_background_choices() {
		...
		$choices = array(
			'repeat' => array(
				'no-repeat' => __( 'No Repeat', 'open-mart' ),
				'repeat'    => __( 'Tile', 'open-mart' ),
				'repeat-x'  => __( 'Tile Horizontally', 'open-mart' ),
				'repeat-y'  => __( 'Tile Vertically', 'open-mart' )
			),
			'size' => array(
				'auto'    => __( 'Default', 'open-mart' ),
				'cover'   => __( 'Cover', 'open-mart' ),
				'contain' => __( 'Contain', 'open-mart' )
			),
			'position' => array(
				'left top'      => __( 'Left Top', 'open-mart' ),
				'left center'   => __( 'Left Center', 'open-mart' ),
				'left bottom'   => __( 'Left Bottom', 'open-mart' ),
				'right top'     => __( 'Right Top', 'open-mart' ),
				'right center'  => __( 'Right Center', 'open-mart' ),
				'right bottom'  => __( 'Right Bottom', 'open-mart' ),
				'center top'    => __( 'Center Top', 'open-mart' ),
				'center center' => __( 'Center Center', 'open-mart' ),
				'center bottom' => __( 'Center Bottom', 'open-mart' )
			),
			'attach' => array(
				'fixed'   => __( 'Fixed', 'open-mart' ),
				'scroll'  => __( 'Scroll', 'open-mart' )
			)
		);
